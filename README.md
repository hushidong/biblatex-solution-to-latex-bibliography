...
* biblatex 标准样式
* 与传统bst样式对应的样式，比如plain，unsrt，alpha，abbrv，ieeetr，acm，Siam，apalike，ams，abstract
* 其它样式比如：trad-plain，trad-unsrt，trad-alpha，trad-abbrv，biblatex-apa，ieee，nature，science，iso690，biblatex-dw
* 关联和条目集的差异
...
* pagination域
* mancite
* AtEveryCitekey处检测数据来实现筛选，替换，AtDataInput处对每个条目做检测以实现筛选，利用check，利用map，
或者在宏中利用判断比如ifcitation等进行判断和后续操作
