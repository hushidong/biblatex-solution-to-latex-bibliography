...
%----------------页面布局、双栏----------------
\usepackage[a4paper,top=3cm, bottom=1.5cm, left=3cm, right=3cm]{geometry}
...
\titlespacing*{\subsection}{0pt}{3mm}{0pt}[0pt]
...
style=gb7714-2015,gbalign=center]{biblatex}%biber
...
itemsep=0pt,leftmargin=2em}%label=$\triangleright$ label=\color{blue}$\blacktriangleright$,
%\setlist[itemize]{topsep=2pt,partopsep=0pt,parsep=0pt,%
