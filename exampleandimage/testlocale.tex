\documentclass[twoside]{article}
    ...
    \usepackage{hyperref}
    \usepackage{lipsum}
%\usepackage[backend=biber,style=gb7714-2015ay]{biblatex}%unicode顺序

%\usepackage[backend=biber,style=gb7714-2015ay,
%sortlocale=zh]{biblatex}%unicode顺序

\usepackage[backend=biber,style=gb7714-2015ay,%
sortlocale=zh__pinyin]{biblatex}% 拼音

%\usepackage[backend=biber,style=gb7714-2015ay,%
%sortlocale=zh__big5han]{biblatex}%big5 编码顺序

%\usepackage[backend=biber,style=gb7714-2015ay,%
%sortlocale=zh__gb2312han]{biblatex}%GB-2312 顺序

%\usepackage[backend=biber,style=gb7714-2015ay,%
%sortlocale=zh__stroke]{biblatex}% 笔划数顺序

%\usepackage[backend=biber,style=gb7714-2015ay,%
%sortlocale=zh__zhuyin]{biblatex}% 注音顺序
